...
$args = array(
	...
	'menu_title'                => esc_html__( 'Управление шаблоном', 'your-textdomain-here' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'Управление шаблоном', 'your-textdomain-here' ),
...
require get_template_directory() . '/inc/redux-components/main-setting.php';
require get_template_directory() . '/inc/redux-components/social.php';
...
require get_template_directory() . '/inc/redux-components/home.php';
require get_template_directory() . '/inc/redux-components/partners.php';
require get_template_directory() . '/inc/redux-components/reviews.php';

// -> START About Fields.
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'О компании', 'your-textdomain-here' ),
		'id'    => 'about',
		'icon'  => 'el el-list-alt',
	)
);

require get_template_directory() . '/inc/redux-components/about.php';
require get_template_directory() . '/inc/redux-components/employ.php';
